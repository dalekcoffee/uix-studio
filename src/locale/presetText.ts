...
const PRESET_TEXT: Record<string, Record<Target, string>> = {
  ...
  "About RESOPAL": { ko: "RESOPAL 정보", es: "Acerca de RESOPAL", ja: "RESOPAL について" },
  ...
  "Build a deck at palify.org  ↗": {
    ko: "palify.org에서 덱 만들기  ↗",
    es: "Crea un mazo en palify.org  ↗",
    ja: "palify.org でデッキを作る  ↗",
  },
  "Buttons": { ko: "버튼", es: "Botones", ja: "ボタン" },
  "Card data — Palify · palify.org": {
    ko: "카드 데이터 — Palify · palify.org",
    es: "Datos de cartas — Palify · palify.org",
    ja: "カードデータ — Palify · palify.org",
  },
  "Card templates & TCG field systems — Sharkmake (AKA Flux)": {
    ko: "카드 템플릿 및 TCG 필드 시스템 — Sharkmake (AKA Flux)",
    es: "Plantillas de cartas y sistemas de campo TCG — Sharkmake (AKA Flux)",
    ja: "カードテンプレートと TCG フィールドシステム — Sharkmake (AKA Flux)",
  },
  "Cards & data by Palify · palify.org": {
    ko: "카드와 데이터 제공: Palify · palify.org",
    es: "Cartas y datos por Palify · palify.org",
    ja: "カードとデータ提供: Palify · palify.org",
  },
  ...
  "CREDITS": { ko: "크레딧", es: "CRÉDITOS", ja: "クレジット" },
  "Customisability": { ko: "맞춤 설정 가능성", es: "Personalización", ja: "カスタマイズ性" },
  "Debug info": { ko: "디버그 정보", es: "Info de depuración", ja: "デバッグ情報" },
  "Deck template — Ukilop": { ko: "덱 템플릿 — Ukilop", es: "Plantilla de mazo — Ukilop", ja: "デッキテンプレート — Ukilop" },
  ...
  "Import Palworld TCG decks straight into your world — grab a starter below, or paste a Palify deck link.": {
    ko: "Palworld TCG 덱을 월드로 바로 가져오세요 — 아래에서 스타터를 고르거나 Palify 덱 링크를 붙여 넣으세요.",
    es: "Importa mazos del TCG de Palworld directamente a tu mundo — elige un inicial abajo o pega un enlace de mazo de Palify.",
    ja: "Palworld TCG のデッキをワールドに直接インポート — 下からスターターを選ぶか、Palify のデッキリンクを貼り付けてください。",
  },
  "Import what I pasted": { ko: "붙여 넣은 내용 가져오기", es: "Importar lo que pegué", ja: "貼り付けた内容をインポート" },
  ...
  "Open 1 Booster  ·  BP01": { ko: "부스터 1팩 열기  ·  BP01", es: "Abrir 1 sobre  ·  BP01", ja: "ブースター1パックを開く  ·  BP01" },
  "OR PASTE YOUR OWN": { ko: "또는 직접 붙여 넣기", es: "O PEGA EL TUYO", ja: "または自分で貼り付け" },
  "Organization Name": { ko: "기관 이름", es: "Nombre de la organización", ja: "組織名" },
  "Oshi mark": { ko: "최애 마크", es: "Marca de Oshi", ja: "推しマーク" },
  "Outbound request — drive this field from ProtoFlux": {
    ko: "보내는 요청 — 이 필드를 ProtoFlux로 구동하세요",
    es: "Petición saliente — controla este campo desde ProtoFlux",
    ja: "送信リクエスト — このフィールドを ProtoFlux で駆動してください",
  },
  ...
  "Paste a palify.org deck link here…": {
    ko: "여기에 palify.org 덱 링크를 붙여 넣으세요…",
    es: "Pega aquí un enlace de mazo de palify.org…",
    ja: "ここに palify.org のデッキリンクを貼り付けてください…",
  },
  ...
  "QUICK IMPORT": { ko: "빠른 가져오기", es: "IMPORTACIÓN RÁPIDA", ja: "クイックインポート" },
  "Rating Form": { ko: "평가 양식", es: "Formulario de valoración", ja: "評価フォーム" },
  "Ready — pick a deck, or paste a palify link": {
    ko: "준비 완료 — 덱을 고르거나 palify 링크를 붙여 넣으세요",
    es: "Listo — elige un mazo o pega un enlace de palify",
    ja: "準備完了 — デッキを選ぶか palify のリンクを貼り付けてください",
  },
  ...
  "REQUEST": { ko: "요청", es: "PETICIÓN", ja: "リクエスト" },
  ...
  "RESOPAL is a deck import tool for the Palworld card game. Pick a trial deck or open a booster to spawn a playable set in-world, or paste a Palify deck link to import a build you made yourself.": {
    ...
    es: "RESOPAL es una herramienta de importación de mazos para el juego de cartas de Palworld. Elige un mazo de prueba o abre un sobre para generar un juego listo para jugar en el mundo, o pega un enlace de mazo de Palify para importar una creación tuya.",
    ja: "RESOPAL は Palworld カードゲーム用のデッキインポートツールです。トライアルデッキを選ぶかブースターを開いてすぐ遊べるセットをワールドに出せます。自作のデッキは Palify のリンクを貼り付けてインポートしてください。",
  },
  "RESPONSE": { ko: "응답", es: "RESPUESTA", ja: "レスポンス" },
  "Response body — drive this field from ProtoFlux": {
    ko: "응답 본문 — 이 필드를 ProtoFlux로 구동하세요",
    es: "Cuerpo de la respuesta — controla este campo desde ProtoFlux",
    ja: "レスポンス本文 — このフィールドを ProtoFlux で駆動してください",
  },
  ...
  "The outbound request and the response it came back with.": {
    ko: "보낸 요청과 그에 대한 응답입니다.",
    es: "La petición saliente y la respuesta que devolvió.",
    ja: "送信したリクエストと、返ってきたレスポンスです。",
  },
  ...
  "VTUBER ID CARD": { ko: "버튜버 ID 카드", es: "TARJETA DE ID DE VTUBER", ja: "VTUBER ID カード" },
  "Waiting for a response…": { ko: "응답을 기다리는 중…", es: "Esperando una respuesta…", ja: "レスポンスを待っています…" },
